...
//@pbe (constraint (= (f408f "hello world" "xyz") "hello worldhello world"))
//@pbe (constraint (= (f408f "ab cd" "ab cd") "ab cdab cd"))
//@pbe (constraint (= (f408f "404" "hello world") "404404"))
//@pbe (constraint (= (f408f "404" "ab cd") "404404"))