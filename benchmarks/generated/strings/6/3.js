...
//@pbe (constraint (= (f992f "hello world" "404") "0"))
//@pbe (constraint (= (f992f "" "mno pqr st") "3"))
//@pbe (constraint (= (f992f "xyz" "mno pqr st") "3"))
//@pbe (constraint (= (f992f "ab cd" "404") "0"))
//@pbe (constraint (= (f992f "hello world" "xyz") "0"))