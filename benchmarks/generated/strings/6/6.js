...
//@pbe (constraint (= (f173f "hello world" "404" "xyz") "BBxyzAA"))
//@pbe (constraint (= (f173f "asdf" "mno pqr st" "asdf") "BBasdfAA"))
//@pbe (constraint (= (f173f "404" "xyz" "mno pqr st") "BBmno pqr stAA"))