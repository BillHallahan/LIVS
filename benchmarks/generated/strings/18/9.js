...
function f241f(x_0, x_1)
{
	return lastLetter(f690f(x_0));
}

//@pbe (constraint (= (f301f "404") "64"))
//@pbe (constraint (= (f301f "404") "64"))
//@pbe (constraint (= (f301f "ab cd") "0d"))
//@pbe (constraint (= (f301f "xyz") "6z"))
//@pbe (constraint (= (f301f "asdf") "8f"))