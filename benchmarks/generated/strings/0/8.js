...
function f492f(x_0, x_1)
{
	return f247f(len(x_1));
}

//@pbe (constraint (= (f185f "404") "1"))
//@pbe (constraint (= (f185f "asdf") "1"))
//@pbe (constraint (= (f185f "xyz") "1"))
//@pbe (constraint (= (f185f "mno pqr st") "2"))
//@pbe (constraint (= (f185f "xyz") "1"))