...
function f946f(x_0, x_1, x_2)
{
	return beforeAfter(firstWord(x_1));
}

//@pbe (constraint (= (f320f "xyz" "404") "4"))
//@pbe (constraint (= (f320f "mno pqr st" "404") "4"))
//@pbe (constraint (= (f320f "" "ab cd") "8"))
//@pbe (constraint (= (f320f "ab cd" "asdf") "4"))
//@pbe (constraint (= (f320f "hello world" "") "4"))