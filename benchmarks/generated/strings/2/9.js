...
function f961f(x_0, x_1, x_2)
{
	return f785f(concat(x_2, x_0), x_2, rep(x_0, x_1, x_0));
}

//@pbe (constraint (= (f228f "ab cd") "BabA"))
//@pbe (constraint (= (f228f "vvvvv") "BA"))
//@pbe (constraint (= (f228f "mno pqr st") "BmnoA"))