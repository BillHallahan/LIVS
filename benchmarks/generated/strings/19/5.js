...
//@pbe (constraint (= (f926f "ab cd" "404" "") "0"))
//@pbe (constraint (= (f926f "asdf" "mno pqr st" "asdf") "1"))
//@pbe (constraint (= (f926f "asdf" "vvvvv" "asdf") "1"))
//@pbe (constraint (= (f926f "404" "404" "mno pqr st") "1"))