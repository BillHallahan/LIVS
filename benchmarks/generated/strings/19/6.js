...
//@pbe (constraint (= (f845f "vvvvv" "" "mno pqr st") ""))
//@pbe (constraint (= (f845f "asdf" "vvvvv" "404") ""))
//@pbe (constraint (= (f845f "xyz" "mno pqr st" "hello world") "xyzmno"))
//@pbe (constraint (= (f845f "" "mno pqr st" "vvvvv") "mno"))