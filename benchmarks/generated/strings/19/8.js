...
//@pbe (constraint (= (f555f "mno pqr st" "hello world" "asdf") "mno"))
//@pbe (constraint (= (f555f "vvvvv" "hello world" "hello world") ""))
//@pbe (constraint (= (f555f "mno pqr st" "asdf" "vvvvv") "mno"))
//@pbe (constraint (= (f555f "mno pqr st" "ab cd" "vvvvv") "mno"))