...
function f789f(x_0, x_1)
{
	return lastLetter(x_0);
}

function f760f(x_0, x_1, x_2)
{
	return f275f(beforeAfter(x_0), beforeAfter(x_1));
}

//@pbe (constraint (= (f911f "mno pqr st") "B2A"))
//@pbe (constraint (= (f911f "ab cd") "B2A"))
//@pbe (constraint (= (f911f "asdf") "B2A"))
//@pbe (constraint (= (f911f "xyz") "B1A"))