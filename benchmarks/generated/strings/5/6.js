...
//@pbe (constraint (= (f275f "ab cd" "ab cd") "11"))
//@pbe (constraint (= (f275f "404" "vvvvv") "9"))
//@pbe (constraint (= (f275f "asdf" "ab cd") "10"))
//@pbe (constraint (= (f275f "vvvvv" "asdf") "11"))
//@pbe (constraint (= (f275f "vvvvv" "404") "11"))