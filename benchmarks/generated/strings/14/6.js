...
//@pbe (constraint (= (f62f "mno pqr st" "ab cd") "1"))
//@pbe (constraint (= (f62f "404" "asdf") "1"))
//@pbe (constraint (= (f62f "asdf" "asdf") "1"))
//@pbe (constraint (= (f62f "ab cd" "vvvvv") "1"))
//@pbe (constraint (= (f62f "xyz" "mno pqr st") "2"))