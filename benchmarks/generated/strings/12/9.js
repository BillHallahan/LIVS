...
{
	return f455f(x_0, f455f(x_0, x_1, x_1), len(x_0));
}

//@pbe (constraint (= (f93f "xyz") "B6A"))
//@pbe (constraint (= (f93f "") "B0A"))
//@pbe (constraint (= (f93f "mno pqr st") "B20A"))
//@pbe (constraint (= (f93f "asdf") "B8A"))