...
//@pbe (constraint (= (f221f "hello world") "BBhello worldAA"))
//@pbe (constraint (= (f221f "vvvvv") "BBvvvvvAA"))
//@pbe (constraint (= (f221f "xyz") "BBxyzAA"))
//@pbe (constraint (= (f221f "mno pqr st") "BBmno pqr stAA"))
//@pbe (constraint (= (f221f "mno pqr st") "BBmno pqr stAA"))