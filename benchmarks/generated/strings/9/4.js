...
//@pbe (constraint (= (f12f "hello world" "ab cd") "BBab cdhello worldAA"))
//@pbe (constraint (= (f12f "asdf" "ab cd") "BBab cdasdfAA"))
//@pbe (constraint (= (f12f "vvvvv" "hello world") "BBhello worldvvvvvAA"))