...
//@pbe (constraint (= (f472f "xyz" "xyz") "B3A"))
//@pbe (constraint (= (f472f "404" "ab cd") "B5A"))
//@pbe (constraint (= (f472f "asdf" "ab cd") "B5A"))
//@pbe (constraint (= (f472f "xyz" "asdf") "B4A"))
//@pbe (constraint (= (f472f "vvvvv" "404") "B3A"))