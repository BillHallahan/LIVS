...
function f682f(x_0, x_1)
{
	return f393f(lastLetter(x_1));
}

function f116f(x_0)
{
	return concat(f393f(x_0), f358f(x_0, x_0));
}

//@pbe (constraint (= (f552f "ab cd") "abab"))
//@pbe (constraint (= (f552f "mno pqr st") "mnomno"))
//@pbe (constraint (= (f552f "mno pqr st") "mnomno"))
//@pbe (constraint (= (f552f "vvvvv") ""))