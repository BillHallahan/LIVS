...
function f468f(x_0, x_1, x_2)
{
	return f611f(concat(x_0, x_0), f967f(x_1, x_2), firstWord(x_0));
}

function f199f(x_0)
{
	return f611f(len(x_0), f350f(x_0), f967f(x_0, x_0));
}

//@pbe (constraint (= (f623f "xyz") "12"))
//@pbe (constraint (= (f623f "vvvvv") "12"))
//@pbe (constraint (= (f623f "xyz") "12"))