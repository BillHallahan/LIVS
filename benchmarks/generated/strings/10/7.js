...
//@pbe (constraint (= (f917f "xyz" "hello world") "hello worldhello worldBhello"))
//@pbe (constraint (= (f917f "hello world" "") ""))
//@pbe (constraint (= (f917f "asdf" "vvvvv") "vvvvvvvvvv"))
//@pbe (constraint (= (f917f "hello world" "vvvvv") ""))