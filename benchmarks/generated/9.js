...
function f59(x_0, x_1, x_2)
{
	return f3(x_1, f10(x_2, x_2, x_1), concat(x_1, x_1));
}

//@pbe (constraint (= (f90 1 "") ""))
//@pbe (constraint (= (f90 1 "hello") "hellohellohellohellohello"))
//@pbe (constraint (= (f90 -1 "hi") "hihihihihi"))