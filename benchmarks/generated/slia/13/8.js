...
//@pbe (constraint (= (f303f 1 "asdf" "xyz") 81))
//@pbe (constraint (= (f303f 7 "404" "xyz") 81))
//@pbe (constraint (= (f303f 9 "asdf" "vvvvv") 169))
//@pbe (constraint (= (f303f 2 "vvvvv" "vvvvv") 169))
//@pbe (constraint (= (f303f 5 "404" "xyz") 81))