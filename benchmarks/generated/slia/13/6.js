...
//@pbe (constraint (= (f836f "hello world" 1) 121))
//@pbe (constraint (= (f836f "vvvvv" 2) 25))
//@pbe (constraint (= (f836f "vvvvv" 6) 25))
//@pbe (constraint (= (f836f "hello world" 7) 121))
//@pbe (constraint (= (f836f "mno pqr st" 4) 100))