...
function f867f(x_0, x_1, x_2)
{
	return concat(concat(x_1, x_1), f810f(x_1));
}

//@pbe (constraint (= (f942f 5 1 0) "1"))
//@pbe (constraint (= (f942f 4 7 4) "49"))
//@pbe (constraint (= (f942f 4 8 0) "64"))