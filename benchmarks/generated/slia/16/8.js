...
//@pbe (constraint (= (f626f "ab cd" "mno pqr st") 70))
//@pbe (constraint (= (f626f "hello world" "vvvvv") 286))
//@pbe (constraint (= (f626f "vvvvv" "hello world") 70))
//@pbe (constraint (= (f626f "asdf" "asdf") 48))
//@pbe (constraint (= (f626f "ab cd" "404") 70))