...
function f627f(x_0, x_1, x_2)
{
	return mult(f785f(x_0, x_2), x_1);
}

//@pbe (constraint (= (f988f "mno pqr st" 9 "ab cd") 14))
//@pbe (constraint (= (f988f "mno pqr st" -5 "vvvvv") 14))
//@pbe (constraint (= (f988f "asdf" 8 "") 4))
//@pbe (constraint (= (f988f "hello world" 1 "ab cd") 14))
//@pbe (constraint (= (f988f "" -5 "") 4))